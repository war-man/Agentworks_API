...
{
    /// <summary>
    ///     Handler for SendCompleteStagedForNewCustomer
    /// </summary>
    public class StagedSendHandler : BaseHandler
    {
        ...
        public StagedSendHandler(IMessageBus messageBus, ISendParametersViewModel sendParameters,
        ...
        /// </summary>
        public override string Display { get; } = "Staged Send";

        /// <summary>
        ///     Unique identifier for the type of transaction we're doing.
        /// </summary>
        public override string TransactionName => StaticTransactionNames.StagedSend;
        /// <summary>
        ///     This session's type
        /// </summary>
        ...
        public override BaseParams BuildParams => new StagedSendParameters
        {
        ...
        public override ITransactionResult Transaction(object parameters)
        {
            ...
            sendData = SendOperations.SendCompleteStagedForNewCustomer(sendData);
        ...
        public override void ResultHandler(ITransactionResult transactionResult, TransactionQueueMode mode, Guid guid)
        {
            ...
            var confirmationNumber = sendData?.CompleteSessionResp?.Payload?.ConfirmationNumber;
