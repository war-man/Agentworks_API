...
namespace TransactionRunner.ViewModels
{
    ...
    /// 
    /// </summary>
    public class StagedBillPayViewModel : BaseAgentViewModel, IStagedBillPayViewModel
    {
        private readonly string _transactionName = StaticTransactionNames.StagedBillPay;
        ...
        //    ? _countrySubdivisionRepository.GetValue<List<SubdivisionInfo>>(_selectedCountry.CountryCode).Where(x => _delimitedStates.Contains(x.CountrySubdivisionCode.Replace("US-",""))).ToList()
        //    : NoSubdivisions;
