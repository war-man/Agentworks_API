...
namespace TransactionRunner.Controls
{
    ...
    /// </summary>
    public partial class StagedBillPayControl : UserControl
    {
        private IStagedBillPayViewModel _vm;
        public StagedBillPayControl()
        {
            InitializeComponent();
        }

        private void StagedBillPayControl_Initialized(object sender, EventArgs e)
        {
            _vm = StaticStagedBillPayVm.StagedBillPayViewModel;
            _vm.Initialize();
            DataContext = _vm;
